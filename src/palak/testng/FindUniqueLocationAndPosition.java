...
public class FindUniqueLocationAndPosition extends PredefinedActions {
	WebDriver driver;
	WebDriverWait wait;
	...
	void findUniqueOfficeLocation() {
		...
		int size = driver.findElements(By.xpath("//span/a[@tabindex='0']")).size();
			...
			for (int outerIndex = 1; outerIndex <= size; outerIndex++) {
				//Get Row Size - 10, at last  page 7
		...
		System.out.println("***Unique office Locations List is below***");
	...
	void findUniquePosition() {
		...
		System.out.println("\n***Unique Positions list is below***");
