...
public class SeleniumTest3_TestCase2 extends PredefinedFunctions {
	WebDriver driver;
	WebDriverWait wait;
	...
	void testCase2() {
		...
		driver.findElement(By.id("userName")).sendKeys("barkhapatle18@gmail.com");
		...
		String actualName=driver.findElement(By.xpath("//span[@class='accountUserName col-xs-12 reset-padding']")).getText();
		if (actualName.equals("Barkha")){
			System.out.println("Barkha Name is present at right corner of page.");
		}else
